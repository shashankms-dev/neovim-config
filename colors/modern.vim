" Vim color file
" Name:       modern.vim
" Maintainer: Shashank M Shanbhag <shashankmshanbhag@gmail.com>
" Homepage:   http://github.com/shashankms/vim-modern/
"
" This should work in the GUI, rxvt-unicode (88 colour mode) and xterm (256
" colour mode). It won't work in 8/16 colour terminals.
"
" To use a black background, :let g:modern_black_background = 1
...
if ! exists("g:modern_black_background")
    let g:modern_black_background = 0
endif

if has("gui_running")
    if ! g:modern_black_background
        hi Normal         gui=NONE   guifg=#cfbfad   guibg=#111111
    else
    ...
    hi ModeMsg        gui=BOLD       guifg=#aeaeae       guibg=NONE
    ...
    hi LineNr         gui=NONE       guifg=#aaaaca       guibg=#2e2e2e
    hi NonText        gui=BOLD       guifg=#8b8bcd       guibg=NONE
    hi SpecialKey     gui=BOLD       guifg=#3b205d       guibg=NONE
    hi Title          gui=BOLD       guifg=#af4f4b       guibg=NONE
    hi Visual         gui=NONE       guifg=#eeeeee       guibg=#4e4e8f

    hi Comment        gui=ITALIC     guifg=#7c7c7c       guibg=NONE
    hi Constant       gui=NONE       guifg=#ff0086       guibg=NONE
    hi String         gui=NONE       guifg=#cb660a       guibg=NONE
    hi Error          gui=NONE       guifg=#ffffff       guibg=#6e2e2e
    hi Identifier     gui=NONE       guifg=#ff8bff       guibg=NONE
    hi Ignore         gui=NONE
    hi Number         gui=NONE       guifg=#df0086       guibg=NONE
